...
#define NVG_NIGHT_ITEM("NVGoggles_OPFOR")	if (daytime < 9 || daytime > 18) then { "NVGoggles_OPFOR" } else { "" }
...
kit_ussf_pl =
	...
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ","ItemMap","ItemCompass","ItemWatch","ItemRadio", NIGHT_ITEM("NVGoggles_OPFOR"), "Binocular"],
...
kit_ussf_ar =
	...
	["<LAUNCHER WEAPON >>  ","","",["","","",""]],
	["<HANDGUN WEAPON >>  ","","",["","","",""]],
	["<ASSIGNED ITEMS >>  ","ItemMap","ItemCompass","ItemWatch","ItemRadio", NIGHT_ITEM("NVGoggles_OPFOR")],
